...
const SECTIONS = [
  {
    ...
    columns: [
      { name: "project_name", label: "과제명", required: true, format: "텍스트 (UNIQUE)", example: "DRAM 3세대 고속 개발" },
      { name: "dev_type", label: "개발 유형", required: false, format: "텍스트", example: "신규개발" },
      { name: "dev_category", label: "개발 분류", required: false, format: "텍스트", example: "DRAM" },
      { name: "verification_lv", label: "검증 레벨", required: false, format: "텍스트", example: "Lv2" },
      { name: "preceding_type", label: "선행 유형", required: false, format: "텍스트", example: "양산선행" },
      { name: "target_device", label: "대상 디바이스", required: false, format: "텍스트", example: "D1a" },
      { name: "first_target_tech", label: "1차 대상 기술", required: false, format: "텍스트", example: "1a DRAM" },
      { name: "second_target_tech", label: "2차 대상 기술", required: false, format: "텍스트", example: "1b DRAM" },
      { name: "htrs_link", label: "HTRS 링크", required: false, format: "URL", example: "https://htrs.example.com/123" },
      { name: "htrs_color", label: "HTRS 색상", required: false, format: "텍스트", example: "Green" },
      { name: "nudd", label: "NUDD", required: false, format: "텍스트", example: "N" },
      { name: "module", label: "모듈", required: false, format: "텍스트", example: "Cell" },
      { name: "project_code", label: "과제 코드", required: false, format: "텍스트", example: "PRJ-2025-001" },
      { name: "start_date", label: "시작일", required: false, format: "YYYY-MM-DD", example: "2025-01-15" },
      { name: "pm", label: "PM", required: false, format: "텍스트 (이름)", example: "김철수" },
      { name: "project_grade", label: "과제 등급", required: false, format: "텍스트", example: "S" },
      { name: "project_purpose", label: "과제 목적", required: false, format: "자유 텍스트", example: "고속 DRAM 셀 구조 개발" },
      { name: "project_goal", label: "과제 목표", required: false, format: "자유 텍스트", example: "tRCD 10ns 이하 달성" },
      { name: "current_status", label: "현재 상태", required: false, format: "텍스트", example: "진행중" },
    ],
  },
  {
    key: "experiment",
